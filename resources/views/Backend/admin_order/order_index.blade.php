...
<body>
    ...
    <div class="content">
        ...
        <div class="text-center" style="font-size: 30px">
            <h2>รายการสั่งซื้อ Package<br></h2>
        </div>
        &nbsp;
        &nbsp;
                ...
                <table id="order_table" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>{{$od->name_lastname}}</td>
                            <td>{{$od->name_package}}</td>
                            <td>{{$od->price}}</td>
                            <td>{{$od->package_created_at}}</td>
                            <td>
                                @if($od->status == 0)
                                <a href="#" class="btn btn-warning btn-sm">
                            ...
                            <td>
                                    ...
                                    <a class="btn btn-info" href="{{route('package_admin.show',$od->package_id)}}">ดูรายละเอียด</a>
