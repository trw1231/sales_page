   ...
   @include('Frontend.side_menu')
    ...
    <div class="container-fluid">
        <div class="content">
            ...
            <div class="container-fluid">
                <p class="text-center" style="font-size: 30px">เปลี่ยนรหัสผ่าน</p>
                <div class="row">
                    <div class="col-3">&nbsp;</div>
                    <div class="col-6">
                        <label style="color: #696969;">รหัสผ่านใหม่</label>
                        <input type="text" class="p-2" style="width:90%;border: 1px solid #d1d3e2;border-radius: .35rem;" name="txt_page_name" id="txt_page_name">
                    </div>
                </div>
                &nbsp;
                <div class="row">
                    <div class="col-3">&nbsp;</div>
                    <div class="col-6">
                        <label style="color: #696969;">รหัสผ่านใหม่ (อีกครั้ง)</label>
                        <input type="text" class="p-2" style="width:90%;border: 1px solid #d1d3e2;border-radius: .35rem;" name="txt_page_name" id="txt_page_name">
                    </div>
                </div>
                &nbsp;
                <div class="row">
                    <div class="col-3">&nbsp;</div>
                    <div class="col-6">
                        <label style="color: #696969;">รหัสผ่านเดิม</label>
                        <input type="text" class="p-2" style="width:90%;border: 1px solid #d1d3e2;border-radius: .35rem;" name="txt_page_name" id="txt_page_name">
                    </div>
                </div>
                <div class="text-center">
                    <button class="mt-4 mr-3 mb-4 btn" style="background-color: blue;color:aliceblue">บันทึกรหัสผ่าน</button>
                </div>
            </div>
        </div>
    </div>
